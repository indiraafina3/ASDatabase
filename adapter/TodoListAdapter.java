package com.codepolitan.myapplicationdatabase.adapter;
...
import com.codepolitan.myapplicationdatabase.InsertDataActivity;
import com.codepolitan.myapplicationdatabase.R;
...
public class TodoListAdapter extends RecyclerView.Adapter<TodoListAdapter.TodoListHolder> {
    ...
    holder.doneImageView.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            builder.setMessage("apakah anda sudah melakukan task tersebut?");
